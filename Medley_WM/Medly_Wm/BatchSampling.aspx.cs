    ...
    public partial class BatchSampling : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int isucess = 0;
                isucess = dbObj.Insertsampling(txtBatchno.Text, txtSamNo.Text, Convert.ToInt32(ddlSelectapprover.SelectedValue), ddlStatus.SelectedItem.Text, DateTime.Parse(today));
                ...
                if (dssampling.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        string BtachNo = dssampling.Tables[0].Rows[i]["Productid"].ToString();
