        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (btnSubmit.Text == "Update")
                {
                    ...
                    int isucess = 0;
                    isucess = dbObj.UpdateSuplier(Convert.ToInt32(ViewState["vssupl"].ToString()), Convert.ToDateTime(txtadditionaldate.Text), txtcompanyname.Text, txtcontactname.Text, txtcontactname1.Text, txtcontactname2.Text, txtcontactname3.Text, txtcontactname4.Text, txtcontactemail.Text, (txtContactnumber.Text), Convert.ToDateTime(txtvalidtill.Text), ddlsuplierstatus.SelectedItem.Text, ddlsuplierqualification.SelectedItem.Text, txtaddressline1.Text, Addres2.Text, Addres3.Text, Addres4.Text, Addres5.Text, ddlcountry.SelectedValue, txtposcode.Text, ddlSelectapprover.SelectedValue, ddlStatus.SelectedItem.Text);
                    isucess = dbObj.deleteTransSuplier(Convert.ToInt32(ViewState["vssupl"].ToString()));

                    int iSuccess1 = dbObj.InsertTransSuplier(Convert.ToInt32(ViewState["vssupl"]), txtcontactname.Text, txtcontactemail.Text, txtContactnumber.Text, txtaddressline1.Text, Convert.ToInt32(ddlcountry.SelectedValue), txtposcode.Text, ddlNumber.SelectedItem.Text);
                    if (divContact2.Visible == true && txtCName1.Text != "")
                    {

                        int iSuccess2 = dbObj.InsertTransSuplier(Convert.ToInt32(ViewState["vssupl"]), txtCName1.Text, txtCEmail1.Text, txtCNumber1.Text, txtCAddress1.Text, Convert.ToInt32(ddlCCountry1.SelectedValue), txtCPost1.Text, ddlCCode1.SelectedItem.Text);
                    }

                    if (divContact3.Visible == true && txtCName2.Text != "")
                    {

                        int iSuccess3 = dbObj.InsertTransSuplier(Convert.ToInt32(ViewState["vssupl"]), txtCName2.Text, txtCEmail2.Text, txtCNumber2.Text, txtCAddress2.Text, Convert.ToInt32(ddlCCountry2.SelectedValue), txtCPost2.Text, ddlCCode2.SelectedItem.Text);
                    }
                    ...
                    if (divContact4.Visible == true && txtCName3.Text != "")
                    {
                        ...
                        int iSucces4 = dbObj.InsertTransSuplier(Convert.ToInt32(ViewState["vssupl"]), txtCName3.Text, txtCEmail3.Text, txtCNumber3.Text, txtCAddress3.Text, Convert.ToInt32(ddlCCountry3.SelectedValue), txtCPost3.Text, ddlCCode3.SelectedItem.Text);
                    }
