                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        <li class="nav-item start ">
                          <a href="Dashbord.aspx" class="nav-link ">
                           ...
                           <li class="nav-item  ">
                            <a href="#" class="nav-link nav-toggle">
                                ...
                                <ul class="sub-menu">   
                                 ...
                                 <li class="nav-item start ">
                                    <a href="POReport" class="nav-link ">
                                        <i class="icon-bulb"></i>
                                    ...
                                    <a href="GRNReport" class="nav-link ">
                                     ...
                                     <li class="nav-item start ">
                                    <a href="GPNReport" class="nav-link ">
                                        <i class="icon-bulb"></i>
                                    ...
                                    <a href="SamplingReport" class="nav-link ">
                                     ...
                                     <li class="nav-item start ">
                                    <a href="BatchReturnReport" class="nav-link ">
                                        <i class="icon-bulb"></i>
                                        <span class="title">Batch Return Report</span>
                                        <span class="badge badge-success"></span>
                                    </a>
                                </li>
                       ...
                       <li>
                            ...
                            <a href="OrderGoodsPicking.aspx" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                                <span class="title">Order Goods Picking</span>
                                <span class="arrow"></span>
                            </a>
