                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">GRN Reports</span>
                                    </div>
                                    <div class="actions">
                                        <%-- <div class="btn-group">
                             ...
                             <div class="form-body">
                                 <div>
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grnreport" runat="server" DataKeyNames="GRId" CssClass="table table-striped table-success table-active  flip-content" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
