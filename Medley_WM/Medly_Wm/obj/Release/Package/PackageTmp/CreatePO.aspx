te<%@ Page  Language="C#" AutoEventWireup="true"  CodeBehind="CreatePO.aspx.cs" Inherits="Medly_Wm.CreatePO"%>
                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet light">
                                        ...
                                        <div class="col-lg-12">
                                         ...
                                         <div id="tble" runat="server" visible="true">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                            <table>
                                                <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <%-- <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPoqty" runat="server" placeholder="PoQty" AutoPostBack="true" CssClass="form-control" OnTextChanged="txtPoqty_TextChanged"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtPriceperpack" runat="server" placeholder="Priceperpack" AutoPostBack="true" CssClass="form-control" OnTextChanged="txtPoqty_TextChanged">0</asp:TextBox>
                                                    </td>
                                                    <td>
                                    ...
                                    <br />                                       
                                        ...
                                        <asp:GridView ID="grvCreatePo" OnRowCommand="grvCreatePo_RowCommand" runat="server" CssClass="table table-striped  flip-content" AutoGenerateColumns="False" ForeColor="#333333" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" CellPadding="4" GridLines="None" >
                                                    ...
                                                    <%--<asp:GridView ID="grvCreatePo" runat="server" CssClass="table table-striped  flip-content" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grvCreatePo_RowCommand">--%>
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField HeaderText="S.No" DataField="Poid" />
                                        ...
                                        <asp:GridView ID="updategrid" runat="server" CssClass="table table-striped  flip-content" AutoGenerateColumns="False" ForeColor="#333333" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" CellPadding="4" GridLines="None" >
                                                        <AlternatingRowStyle BackColor="White" />
                                                        <Columns>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPoeditqty" CssClass="form-control" AutoPostBack="true"   runat="server" OnTextChanged="txtPoeditqty_TextChanged"    ></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                                                            <asp:BoundField HeaderText="PoQty" DataField="PoQty" />
                                                            <asp:BoundField HeaderText="PricePerPack" DataField="Priceperpack" />
