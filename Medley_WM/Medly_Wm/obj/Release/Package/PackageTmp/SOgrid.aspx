                            ...
                            <div class="caption">
                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <div style="overflow: auto">
                                                <asp:GridView ID="gvSo" runat="server"  DataKeyNames="Soid" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4" OnRowDataBound="gvSo_RowDataBound" ForeColor="#333333" GridLines="None" OnRowCommand="gvSo_RowCommand">
                                            ...
                                            <asp:BoundField HeaderText="Customer Name" DataField="ContactName" />
                                                        ...
                                                        <asp:BoundField HeaderText="Validity" DataField="" />
