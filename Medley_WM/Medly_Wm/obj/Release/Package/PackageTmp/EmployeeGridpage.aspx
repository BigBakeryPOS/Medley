                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="gvEmployee" runat="server" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="gvEmployee_RowCommand">
                                            ...
                                            <Columns>
                                                ...
                                                <%-- <asp:BoundField HeaderText="Date Of Birth" DataField="DateofBirth" DataFormatString="{0:MM/dd/yyyy}" />
                                                                 <asp:BoundField HeaderText="Date Of Joining" DataField="DateofJoining" DataFormatString="{0:MM/dd/yyyy}" />--%>
                                                ...
                                                <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btndel" runat="server" CommandArgument='<%#Eval("EmployeeID") %>'
                                                            ...
                                                            <asp:ImageButton ID="imgDel" ImageUrl="~/Images/delete.png" runat="server" Width="20px" CommandArgument='<%#Eval("EmployeeID")%>' CommandName="Del" OnClientClick="return confirm('Are you sure to delete this?');" />
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
