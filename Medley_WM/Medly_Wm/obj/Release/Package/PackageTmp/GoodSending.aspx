                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body flip-scroll">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:DropDownList ID="ddlSo" runat="server" OnSelectedIndexChanged="ddlSo_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="gvGoods" runat="server" OnRowCommand="gvSo_RowCommand" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Pack size" DataField="Packsize" />--%>
                                                 <asp:BoundField HeaderText="SupplierId" DataField="SupplierId" Visible="false"/>
                                                ...
                                                <asp:TemplateField HeaderText="Pick" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnPick" runat="server" CommandArgument='<%#Eval("Productid") +","+ Eval("SoQty")+","+ Eval("SupplierId") %>'
