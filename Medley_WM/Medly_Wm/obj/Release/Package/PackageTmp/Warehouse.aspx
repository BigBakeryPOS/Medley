                                    ...
                                    <div class="form-body">
                                        <div class="col-lg-12">
                                            <div class="col-lg-4">
                                                ...
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtWarehousename" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                <asp:TextBox ID="txtWarehousename" runat="server" CssClass="form-control" ReadOnly="true" placeholder="Medley" />
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtWarehousecode" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                <asp:TextBox ID="txtWarehousecode" runat="server" CssClass="form-control" ReadOnly="true" placeholder="ME112" />
