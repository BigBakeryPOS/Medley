                                    ...
                                    <div class="portlet light" style="height:1600px">
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <%-- <div class="col-lg-3">
                                                            <label>Product name:</label>
                                                             <asp:TextBox ID="txtProductName" ReadOnly="false" CssClass="form-control" runat="server"></asp:TextBox>
                                                        </div>--%>
                                                        
                                                       <%-- <div class="col-lg-3">
                                                            <div class="form-group">
                                                            <label>Licence Number</label>
                                                             <asp:TextBox ID="txtLicenceNo" CssClass="form-control"  ReadOnly="false" runat="server"></asp:TextBox>
                                                                </div>
                                                        </div>--%>
                                                        <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-12">
                                                       ...
                                                       <%-- <div class="col-lg-2">
                                                            <label>Pack type:</label>
                                                             <asp:TextBox ID="txtPacktype" CssClass="form-control"  ReadOnly="false" runat="server"></asp:TextBox>
                                                        </div>

                                                        <div class="col-lg-2">
                                                            <label>Pack size:</label>
                                                             <asp:TextBox ID="txtPacksize" CssClass="form-control"  ReadOnly="false" runat="server"></asp:TextBox>
                                                        </div>--%>
