    ...
    public partial class OrderGoodsPicking1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    string script = "alert('No Stock available or Set Status to Release!')";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //    string Unit =gvPo.Rows[i].Cells[7].Text;
                ...
                for (int vLoop = 0; vLoop < gvPo.Rows.Count; vLoop++)
                {
                    ...
                    int isuccess1 = dbObj.InsertTransGPN(GPNID, Convert.ToInt32(txtProductId.Text), 0, Convert.ToInt32(txtremarks.Text), 0, 0, 0, "", txtUnitname.Text, txtPalletsrefno.Text);
            ...
            Response.Redirect("GoodsPickGrid.aspx");
        }
    }
}