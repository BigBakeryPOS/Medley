                        ...
                        <div class="portlet-body flip-scroll">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                   ...
                                   <div class="col-lg-4">
                                    <div class="form-group">
                                        <asp:DropDownList CssClass="form-control" ID="ddlProduct" runat="server" OnSelectedIndexChanged="ddlSo_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
