                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div style="overflow: auto">
                                            <asp:GridView ID="gvpick" runat="server" DataKeyNames="id" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4"  OnRowDataBound="gvpick_RowDataBound" ForeColor="#333333" GridLines="None" OnRowCommand="gvpick_RowCommand">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Sales Order ID">
                                                        <ItemTemplate>
                                                            ...
                                                            <img id="imgdiv<%# Eval("id") %>" width="30px" border="0" src="plus.gif" />
                                                        </a> 
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <div id="div<%# Eval("id") %>" style="display: none; position: relative; left: 15px; overflow: auto">
                                                            <asp:GridView ID="sopickgrid" runat="server" DataKeyNames="GoodPickid" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None" Visible="false">
                                                                <AlternatingRowStyle BackColor="White" />
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Sl No">
                                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Print" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="print" runat="server" CommandArgument='<%#Eval("id") %>'
                                                                CommandName="View" >

                                                                <asp:ImageButton ID="btnview" ImageUrl="~/Images/product.png" runat="server" Width="20px" CommandArgument='<%#Eval("id") %>'
                                                                    CommandName="View" />
                                                            </asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
